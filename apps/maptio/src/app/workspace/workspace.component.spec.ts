...
export class AuthStub {
  fakeProfile: User = new User({
    ...
    picture: 'http://seemyface.com/user.jpg',
    user_id: 'someId',
...
describe('workspace.component.ts', () => {
  ...
  describe('Controller', () => {
    ...
    describe('openDetails', () => {
      xit(
        'should call correct dependencies and keep building panel opened',
        waitForAsync(() => {
          component.dataset = new DataSet({
            initiative: new Initiative({
              id: 1,
              name: 'Name',
              children: [new Initiative({ id: 2, name: 'opening' })],
            }),
          });
      ...
      xit(
        'should call correct dependencies and keep building panel closed',
        waitForAsync(() => {
          component.dataset = new DataSet({
            initiative: new Initiative({
              id: 1,
