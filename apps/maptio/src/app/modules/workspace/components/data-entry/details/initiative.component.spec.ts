...
describe('initiative.component.ts', () => {
        ...
        providers: [
          ...
          },
          {
            ...
            useClass: class {
              ...
              getUser = jest
                .fn()
                .mockReturnValue(observableOf(new User({ user_id: 'UID' })));
            },
          },
          MarkdownService,
          MarkedOptions,
  ...
  beforeEach(() => {
    ...
    component.node = new Initiative({
      name: 'ORIGINAL',
      description: 'ORIGINAL',
    });
    component.dataset = new DataSet({
      datasetId: '123',
      initiative: new Initiative({ name: 'initiative' }),
    });
  ...
  describe('Controller', () => {
    ...
    describe('removeHelper', () => {
      it('should remove helper from list', () => {
        spyOn(component, 'onBlur');
        component.node.helpers = [
          new Helper({ name: 'John Doe', user_id: '1' }),
          new Helper({ name: 'Jane Doe', user_id: '2' }),
        ];
