...
@Component({
    ...
    standalone: true,
    imports: [NgIf, StickyPopoverDirective, InitiativeHelperRoleSelectComponent, InitiativeHelperRoleInputComponent, NgFor, InitiativeHelperRoleComponent, RouterLink]
})
