...
describe('signup.component.ts', () => {
  ...
  describe('createAccount', () => {
    it(
      'doesnt do anything if the form are not valid',
      waitForAsync(() => {
    ...
    it(
      "should display 'activate' message if user exits and activtion is pending",
      waitForAsync(() => {
        component.signupForm.setValue({
          firstname: 'something',
          lastname: 'something',
    ...
    it(
      "should display 'login' message if user exits and activtion is not pending",
      waitForAsync(() => {
        component.signupForm.setValue({
          firstname: 'something',
          lastname: 'something',
    ...
    it(
      'should signup user when email doesnt exist and display confirmation message',
      waitForAsync(() => {
        component.signupForm.setValue({
          firstname: 'something',
          lastname: 'something',
    ...
    it(
      "should signup user when email doesnt exist and display error message when user can't be created",
      waitForAsync(() => {
        component.signupForm.setValue({
          firstname: 'something',
          lastname: 'something',
    ...
    it(
      'should signup user when email doesnt exist and display error message when email cannot be sent',
      waitForAsync(() => {
        component.signupForm.setValue({
          firstname: 'something',
          lastname: 'something',
