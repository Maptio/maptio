    ...
    if (this.teamSettingsForm.valid && this.teamSettingsForm.dirty) {
      ...
      this.teamFactory
        ...
        .then((isUpdated: boolean) => {
          ...
          this.intercom.trackEvent('Change terminology', {
            team: this.team.name,
            teamId: this.team.team_id,
            authority: updatedTeam.settings.authority,
            helper: updatedTeam.settings.helper,
          });
        ...
        .then(() => {
          this.router.navigate(
            ['teams', this.team.team_id, this.team.getSlug(), 'settings'],
