...
@Component({
    ...
    standalone: true,
    imports: [PermissionsDirective, ConfirmationPopoverModule, NgIf, NgbTooltipModule, NgFor, FormsModule, StickyPopoverDirective, MemberFormComponent, SlicePipe, KeysPipe]
})
