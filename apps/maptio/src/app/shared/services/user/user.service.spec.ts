...
describe('user.service.ts', () => {
  ...
  describe('isUserExist', () => {
    it('should return true when ther is only one user matching the email', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          http: Http,
          ...
          mockBackend.connections.subscribe((connection: MockConnection) => {
            if (
              ...
              connection.request.url ===
                `${environment.USERS_API_URL}?include_totals=true&search_engine=v3&q=email%3A%22ido%40exist.com%22` &&
          ...
          target.isUserExist('ido@exist.com').then((result) => {
    ...
    it('should return false when ther is more than user matching the email', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
    ...
    it('should return false when there is no user matching the email', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
  ...
  describe('changePassword', () => {
    it('should call right dependencies', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          expect(webAuth.changePassword).toHaveBeenCalledWith(
            {
  ...
  describe('updateInvitiationSentStatus', () => {
    it('should call right dependencies when invitation is sent', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          target.updateInvitiationSentStatus('ID', true).then((result) => {
            expect(spyAccessToken).toHaveBeenCalled();
            expect(result).toBe(true);
          });
        }
    ...
    it('should call right dependencies when invitation is not sent', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          target.updateInvitiationSentStatus('ID', false).then((result) => {
            expect(spyAccessToken).toHaveBeenCalled();
            expect(result).toBe(true);
          });
        }
  ...
  describe('updateActivationPendingStatus', () => {
    it('should call right dependencies when activation is pending', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          target.updateActivationPendingStatus('ID', true).then((result) => {
            expect(spyAccessToken).toHaveBeenCalled();
            expect(result).toBe(true);
          });
        }
    ...
    it('should call right dependencies when activation is not pending', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          mockBackend.connections.subscribe((connection: MockConnection) => {
            if (
              ...
              connection.request.headers.get('Authorization') ===
                'Bearer token' &&
              connection.request.json().app_metadata.activation_pending ===
                false
            ) {
              connection.mockRespond(
                new Response(
          ...
          target.updateActivationPendingStatus('ID', false).then((result) => {
            expect(spyAccessToken).toHaveBeenCalled();
            expect(result).toBe(true);
          });
        }
    ...
    it('should call right dependencies ', fakeAsync(
      inject(
        ...
        (
          ...
          target
            .updateUserCredentials('ID', 'secret', 'I', 'D')
            .then((result) => {
              expect(spyAccessToken).toHaveBeenCalled();
              expect(result).toBe(true);
            });
  ...
  describe('isInvitationSent', () => {
    it('should return true when invititaion is sent', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          target.isInvitationSent('ID').then((result) => {
            expect(spyAccessToken).toHaveBeenCalled();
            expect(result).toBe(true);
          });
        }
    ...
    it('should return false when invititaion is false', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
    ...
    it('should return false when app_metadata is missing', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
  ...
  describe('isActivationPendingByEmail', () => {
    it('should return true when there is only one user matching the email and their activation is pending', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          target.isActivationPendingByEmail('ido@exist.com').then((result) => {
            expect(spyAccessToken).toHaveBeenCalled();
    ...
    it('should return false when there is only one user matching the email and their activation not is pending', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
    ...
    it('should return false when there is only one user matching the email and their app_metadata is missing', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
    ...
    it('should return false when there is no one matching the email ', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
  ...
  describe('isActivationPendingByUserId', () => {
    it('should return true when activation is pending', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          target.isActivationPendingByUserId('ID').then((result) => {
            expect(spyAccessToken).toHaveBeenCalled();
            expect(result).toBe(true);
          });
        }
    ...
    it('should return false when activation is not pending', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
  ...
  describe('createUser', () => {
    it('should call right dependencies when it is a sign up', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          mockBackend.connections.subscribe((connection: MockConnection) => {
            if (
              ...
              connection.request.json().app_metadata.activation_pending ===
                true &&
              connection.request.json().app_metadata.invitation_sent ===
                false &&
              connection.request.json().user_metadata.given_name === 'I' &&
          ...
          target
            .createUser('someone@company.com', 'I', 'Am', true)
            .then((result) => {
              expect(spyAccessToken).toHaveBeenCalled();
            });
        }
  ...
  describe('generateUserToken', () => {
    it('should call right dependencies', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend, JwtEncoder],
        (
          target: UserService,
          http: Http,
          configuration: AuthConfiguration,
          ...
          target
            .generateUserToken('ID', 'someone@company.com', 'I', 'Am')
            .then((token) => {
              expect(token).toBe('token');
              expect(spyEncoding).toHaveBeenCalledWith({
                user_id: 'ID',
                email: 'someone@company.com',
                firstname: 'I',
                lastname: 'Am',
  ...
  describe('sendConfirmation', () => {
    it('should call the right dependencies', fakeAsync(
      inject(
        [
          UserService,
          Http,
        ...
        (
          ...
          mockBackend.connections.subscribe((connection: MockConnection) => {
            if (
              ...
              connection.request.json().result_url ===
                'http://app.maptio.com/login?token=userToken'
            ) {
              connection.mockRespond(
                new Response(
                  new ResponseOptions({
          ...
          target
            .sendConfirmation('someone@company.com', 'ID', 'I', 'Am', 'I Am')
            .then(() => {})
            .then(() => {
              Promise.all([
                spyEncoding.calls.mostRecent().returnValue,
                spyAccessToken.calls.mostRecent().returnValue,
              ])
                ...
                .then((ticket) => {
                  expect(spyMailing).toHaveBeenCalledWith(
                    'support@maptio.com',
                    ['someone@company.com'],
                    'http://ticket.com/url'
                  );
  ...
  describe('getUsersInfo', () => {
    it('should not send request call when is empty array', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
          ...
          mockBackend.connections.subscribe((connection: MockConnection) => {
            if (
              connection.request.method === RequestMethod.Get &&
              connection.request.url ===
                `${environment.USERS_API_URL}?per_page=100&q=` &&
              connection.request.headers.get('Authorization') === 'Bearer token'
            ) {
              connection.mockRespond(
                new Response(
    ...
    it('should send request call when non empty array - one request', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
    ...
    it('should send request call when non empty array and retrieve only found users', fakeAsync(
      inject(
        [UserService, Http, AuthConfiguration, MockBackend],
        (
          target: UserService,
    ...
    it('should call right dependencies ', fakeAsync(
      inject(
        ...
        (
          ...
          target.updateUserProfile('ID', 'John', 'Doe').then((result) => {
            expect(spyAccessToken).toHaveBeenCalled();
            expect(result).toBe(true);
          });
        }
        ...
        (
          ...
          mockBackend.connections.subscribe((connection: MockConnection) => {
            if (
              ...
              connection.request.headers.get('Authorization') ===
                'Bearer token' &&
              connection.request.json().user_metadata.picture ===
                'picture_url' &&
              connection.request.json().connection ===
                environment.CONNECTION_NAME
            ) {
          ...
          target.updateUserPictureUrl('ID', 'picture_url').then((result) => {
            expect(spyAccessToken).toHaveBeenCalled();
            expect(result).toBe(true);
          });
        }
