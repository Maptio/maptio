...
export class Team implements Serializable<Team> {
  ...
  deserialize(input: any): Team {
    ...
    deserialized.settings = {
      ...
      vision: environment.DEFAULT_VISION_TERMINOLOGY
    };
    ...
    deserialized.settings.vision = input.settings
      ? input.settings.vision || environment.DEFAULT_VISION_TERMINOLOGY
      : environment.DEFAULT_VISION_TERMINOLOGY;
