...
export class MappingCirclesComponent implements OnInit, IDataVisualizer {
    ...
    draw(data: any) {
        ...
        let circle = g.selectAll("circle")
            ...
            .style("stroke", function (d: any) { return d.data.isSearchedFor ? "#d9831f" : "#f7f7f7" })
        ...
        function showTooltip(d: any, parent: any, event: any, datasetId: string) {
            uiService.setTooltipData(datasetId, d.data, parent.data, event.pageX - 20, event.pageY - 100);
        }
    }
}